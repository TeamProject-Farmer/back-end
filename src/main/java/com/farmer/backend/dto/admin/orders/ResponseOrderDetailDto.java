...
public class ResponseOrderDetailDto {
    ...
    @QueryProjection
    public ResponseOrderDetailDto(Long orderId, String orderNum, String memberName, String hp, String email, String address, DeliveryStatus deliveryStatus, String deliveryMemo, Long totalPrice, int discountPrice, int deliveryPrice, int usePointPrice, int addPoint, String payMethod, Long finalAmount, OrderDetail orderDetail) {
